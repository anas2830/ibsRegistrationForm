...
<head>
	...
	<link href="{{ asset('backend/assets/css/font-awesome/css/font-awesome.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('backend/assets/css/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('backend/assets/css/sytle.css') }}" rel="stylesheet" type="text/css">
